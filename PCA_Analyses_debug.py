...
fig = px.scatter(tsne_df, x="tsne_1", y="tsne_2", title="t-SNE", hover_name="Faculty_Full_Name", hover_data={"tsne_1": False, "tsne_2": False, "Top_Mesh_Terms": True}, width=800, height=800, color_discrete_sequence=['#fecc07'])fig.update_layout(plot_bgcolor='#255799', title={
        'text': "t-SNE",
        'font': {'size': 30},
})
fig.update_xaxes(title_text="")
